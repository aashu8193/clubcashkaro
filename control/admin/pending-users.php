...
if (isset($_SESSION['username']))
{
	...
	{
		$filename = "downloads/pending_users_".strtotime("now").'.csv';
          
        $connection = mysqli_connect('localhost', 'aashu8193', 'peterpan0804', 'fb_student_main_db');      	
		
		$sql = mysqli_query($connection , "SELECT `user_id` , `fid` , `ck_ref_id` , `ref_id_status` , `ck_email_id` , `bonus_points` FROM `user_table` WHERE `ref_id_status` = 'pending'");
...
<html>
<head>
<title>Download Pending Users</title>
...
<div id="page-wrapper">
    <div class="graphs">
	     <div class="xs">
  	       <h3>Download Pending State Users</h3>
