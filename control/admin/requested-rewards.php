...
if (isset($_SESSION['username']))
{
	...
	{
		$filename = "downloads/reward_requests_".strtotime("now").'.csv';
          
        $connection = mysqli_connect('localhost', 'aashu8193', 'peterpan0804', 'fb_student_main_db');      	
		
		$sql = mysqli_query($connection , "SELECT * FROM `redeem_table` WHERE `status` = 'requested'");
...
<html>
<head>
<title>Download Redeem Requests</title>
...
<div id="page-wrapper">
    <div class="graphs">
	     <div class="xs">
  	       <h3>Download Redeem Requests</h3>
