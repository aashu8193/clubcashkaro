...
if (isset($_SESSION['username']))
{
	...
	{
		$filename = "downloads/user_table_".strtotime("now").'.csv';
          
        $connection = mysqli_connect('localhost', 'aashu8193', 'peterpan0804', 'fb_student_main_db');      	
		
		$sql = mysqli_query($connection , "SELECT * FROM `user_table`");
...
<html>
<head>
<title>Download All Users</title>
